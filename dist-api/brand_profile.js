export function getBrandProfile() {
    return {
        ...
        accentColor: null,
        disclaimer: {
            short: "Off-road / motorsports use only. No WOT until blockers are cleared. Verify wideband, fuel system, and calibration before flashing.",
            full: "IMPORTANT SAFETY & LIABILITY NOTICE (Down Dirty 84)\n\n" +
